...
<section class="ftco-section ftco-no-pt ftco-no-pb">
    	...
    	<div class="container">
    		<div class="row col-md-12 d-flex no-gutters">
	            ...
	            <h2 class="mb-4" style="text-align:center;">내 반려식물 자랑하기</h2>
    				</div>
    				<form name="boastWriteForm" class="boastWriteForm" action="boastWrite.kh" method="POST" enctype="multipart/form-data">
	    				  <div class="container">
                  ...
                  <div class="row col-md-12" style="margin-bottom : 30px;">
                     ...
                     <input type="text" id="" class="form-control" name="boastTitle" placeholder="제목을 입력하세요">
                  ...
                  <div class="row col-md-12">
                     ...
                     <input type="text" id="" class="form-control" name="plantNo" placeholder="식물이름 입력하세요 (1~3)">
