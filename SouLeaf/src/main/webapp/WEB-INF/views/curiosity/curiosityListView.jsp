...
<body>
  ...
  <section class="hero-wrap hero-wrap-2" style="background-image: url('resources/images/main_bg_7.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        ...
        <div class="row" style="justify-content: flex-end;" id="curiosity-list">
