      ...
      if(data.length > 0){
        ...
        for(var i in data){
			...
			if(data[i].curiosityFileRename == null){
				str+=' <a href="curiosityDetail.kh?curiosityNo='+data[i].curiosityNo+'&page='+currentPage+'&count='+currentCount+'" class="blog-img mr-4" style="background-image: url(resources/uploadFiles/curiosity/defaultplant.png);"></a>';
			}else{
				str+=' <a href="curiosityDetail.kh?curiosityNo='+data[i].curiosityNo+'&page='+currentPage+'&count='+currentCount+'" class="blog-img mr-4" style="background-image: url(resources/uploadFiles/curiosity/'+data[i].curiosityFileRename+');"></a>';
			}
